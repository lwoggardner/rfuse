...
describe RFuse do
    ...
    context "#parse_options" do
        ...
        it "should remove local options" do
            ...
            argv.should match [ mountpoint, "-o",a_string_including('debug''')]
            argv[2].should_not match a_string_including('myoption')
        ...
        it "should parse values and remove local options" do
            ...
            result[:someopt].should == "somevalue"
            argv[2].should match a_string_including("debug")
        end
        ...
        it "should parse and remove optional device" do
            ...
            argv.should match [ mountpoint , "-o", a_string_including("rw,debug,default_permissions")]
        end
